...
export default function Footer() {
  ...
  return (
    <div className="max-w-7xl mx-auto h-full p-2 flex items-start justify-center">
      <footer className="flex w-full flex-col">
        <div className="max-w-7xl px-6 pb-8 pt-8 sm:pt-10 lg:px-8 lg:pt-20">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8 md:pr-8">
              ...
              <Image src="/images/logo.svg" className="w-40" alt='Logo' />
          ...
          <div className="flex flex-wrap justify-between gap-2 pt-8">
            <p className="text-small text-default-400">&copy; 2024 Fieldtech Co-Intelligence All rights reserved.</p>
            {/* <ThemeSwitch /> */}
          </div>
        </div>
      </footer>
